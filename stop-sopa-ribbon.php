...
function render_stop_sopa_ribbon() {
	...
	echo "<a target='_blank' class='stop-sopa-ribbon' href='http://americancensorship.org/'><img src='{$ribbon_url}' alt='Stop SOPA' style='position: fixed; top: 0; right: 0; z-index: 100000;' /></a>";
}
